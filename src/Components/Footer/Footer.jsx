...
function Footer() {
  return (
    <div className="flex items-center justify-between laptop:px-8 mobile:gap-4 text-slate-50 mobile:flex-col-reverse">
      ...
      <div>
        <ul className="flex items-center laptop:gap-4 mobile:gap-2">
          ...
          <li className="rounded-full hover:bg-[#f0a9aa62] hover:opacity-1 p-[0.4rem]">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
